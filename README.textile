...
h3. Querying spell information

Then you can get information about a spell with GetSpellInfo:
...
bc. if bit.band(flags, LibPlayerSpells.constants.PALADIN) ~ = 0 then
  -- This is a paladin spell, do something.
end
