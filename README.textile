...
* Is this spell a survival cooldown, or use for dps ?
...
Each class has his own data file and can be updated separately from the main code.

h2. Supported classes & specs

Not all classes and specializations are 100% supported yet. Most interrupts, dispels, survival cooldowns and raid buffs are complete. 

If the LibPlayerSpells is missing something specific from your class please file a detailed bug on Github or contribute to the project yourself if you are feeling brave!
...
Most spell information is stored in a bitfield to compact storage and to easily test or filter spells. The bit value constants are available in the LibPlayerSpells.constants table.
